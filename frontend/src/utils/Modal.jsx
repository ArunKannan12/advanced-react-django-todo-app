...
export default function Modal({ isOpen, title, message, onConfirm, onClose }) {
  ...
  return (
   <div className="modal show fade d-block" tabIndex="-1"role="dialog"aria-modal="true"aria-labelledby="sessionModalTitle"aria-describedby="sessionModalDesc"style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}
>
